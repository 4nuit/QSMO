#ifndef TEST_CCNOT_CPP
#define TEST_CCNOT_CPP
...
/**
 * @brief Testing the Toffoli gate on the eight possible states: |000>, |001>, |010>, |011>, |100>, |101>, |110>, |111>.
 *
 * This test ensures that the Toffoli gate gives the expected results for each of these states.
 */
class CCNOTGateTest : public ::testing::Test
{
protected:
    /**
    ...
    const size_t numQubits = 3;              // Three qubits for the Toffoli gate
    const size_t numStates = 1 << numQubits; // 8 states for 3 qubits
};

/**
 * @brief Test the Toffoli gate on the |000> state.
 *
 * This test ensures that the Toffoli gate applied to the |000> state results in the expected |000> state.
 */
TEST_F(CCNOTGateTest, TestState000)
{
    ...
    toffoli(queue, stateVector_d, numQubits, 0, 1, 2, use_single_task); // Apply Toffoli gate (control qubits 0,1 and target qubit 2)
...
/**
 * @brief Test the Toffoli gate on the |001> state.
 *
 * This test ensures that the Toffoli gate applied to the |001> state results in the expected |001> state.
 */
TEST_F(CCNOTGateTest, TestState001)
{
    ...
    queue.memcpy(stateVector_d, stateVector, numStates * sizeof(Complex<float>)).wait();
    toffoli(queue, stateVector_d, numQubits, 0, 1, 2, use_single_task);
    measure(queue, stateVector_d, numQubits, 100, use_single_task);
    queue.memcpy(stateVector, stateVector_d, numStates * sizeof(Complex<float>)).wait();
...
/**
 * @brief Test the Toffoli gate on the |010> state.
 *
 * This test ensures that the Toffoli gate applied to the |010> state results in the expected |010> state.
 */
TEST_F(CCNOTGateTest, TestState010)
{
...
/**
 * @brief Test the Toffoli gate on the |011> state.
 *
 * This test ensures that the Toffoli gate applied to the |011> state results in the expected |011> state.
 */
TEST_F(CCNOTGateTest, TestState011)
{
...
/**
 * @brief Test the Toffoli gate on the |100> state.
 *
 * This test ensures that the Toffoli gate applied to the |100> state results in the expected |100> state.
 */
TEST_F(CCNOTGateTest, TestState100)
{
...
/**
 * @brief Test the Toffoli gate on the |101> state.
 *
 * This test ensures that the Toffoli gate applied to the |101> state results in the expected |101> state.
 */
TEST_F(CCNOTGateTest, TestState101)
{
    Complex<float> expectedState[8] = {Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f),
...
/**
 * @brief Test the Toffoli gate on the |110> state.
 *
 * This test ensures that the Toffoli gate applied to the |110> state results in the expected |111> state.
 */
TEST_F(CCNOTGateTest, TestState110)
{
    Complex<float> expectedState[8] = {Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f),
...
/**
 * @brief Test the Toffoli gate on the |111> state.
 *
 * This test ensures that the Toffoli gate applied to the |111> state results in the expected |110> state.
 */
TEST_F(CCNOTGateTest, TestState111)
{
    Complex<float> expectedState[8] = {Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f), Complex<float>(0.0f, 0.0f),
